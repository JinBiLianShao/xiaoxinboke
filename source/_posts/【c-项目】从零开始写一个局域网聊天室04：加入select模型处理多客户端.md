title: 【c++项目】从零开始写一个局域网聊天室04：加入select模型处理多客户端
author: 连思鑫
tags:
  - C++项目
  - Socket编程
...
categories:
  - 从零开始写一个聊天室系列
date: 2022-07-04 15:46:00
---
## 【c++项目】从零开始写一个局域网聊天室04：加入select模型处理多客户端
...
int main()
{
	...
	while (true)
	{
		...
		else if (0 == strcmp(cmdBuf, "login"))
		{
			...
			strcpy(login.PassWord, "7758521");
			//DataHeader dh = {sizeof(login), CMD_LOGIN};
			//login.userName = "lsx";
			//login.PassWord = "7758521";
			//5 向服务器发送请求命令
...
![uploaded!](/images/2022-7-4-0001.png)


server.exe体验：[点我下载](/download/q0007.exe)

client.exe体验：[点我下载](/download/q0008.exe)