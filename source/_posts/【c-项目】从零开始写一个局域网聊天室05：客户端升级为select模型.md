title: 【c++项目】从零开始写一个局域网聊天室05：客户端升级为select模型
author: 连思鑫
tags:
  - C++项目
  - 服务器项目
...
![upload successful](/images/2022-9-8-001.png)


server.exe体验：[点我下载](/download/q0009.exe)

client.exe体验：[点我下载](/download/q0010.exe)